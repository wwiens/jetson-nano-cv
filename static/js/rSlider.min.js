(function () {
	...
	RS.prototype.setValues = function (start, end) {
		...
		if (this.conf.range) {
            ...
            document.getElementById('trainval').innerHTML = this.conf.values[this.values.start];
            document.getElementById('validationval').innerHTML = this.conf.values[this.values.end] - this.conf.values[this.values.start];
            document.getElementById('testval').innerHTML = 100 - this.conf.values[this.values.end];
